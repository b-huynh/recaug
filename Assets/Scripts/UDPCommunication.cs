...
public class UDPCommunication : Singleton<UDPCommunication>
{
    ...
    public string externalIP = "192.168.100.108";
    ...
    async void Start()
    {
        ...
        try
        {
			...
			Debug.Log("Waiting to bind endpoint...");
			await socket.BindEndpointAsync(null, internalPort);
			Debug.Log("Endpoint Bounded on: " + internalPort);
            Debug.Log("IP: " + IP);
        }
        catch (Exception e)
        {
